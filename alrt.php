...
<body>
	...
	<form action="" method="post" name="frm" id="frm">
    	...
    	<?php
			...
			if(!($v8am>0 || $_REQUEST['v8am']==1 )){$chk=1;}//echo '<br/>'.$v8am;
			if(!(($v10am>0 || $v8am<0)|| $_REQUEST['v10am']==1  )){$chk=1;}//echo '<br/>'.$v10am;
			if(!(($v12pm>0 || $v10am<0) ||$_REQUEST['v12pm']==1)){$chk=1;}//echo '<br/>'.$v12pm;
			if(!( $v2pm<0 || $_REQUEST['v2pm']==1 )){$chk=1;}//echo '<br/>'.$v2pm;
			if($chk==1){ echo $alert;}
				?>
</form>
</body>
